            ...
            <div class="content">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td class="value" style="color: #22c55e;">
                            {{ $payment->expires_at ? $payment->expires_at->format('d M Y') : $payment->subscription?->expires_at?->format('d M Y') ?? '-' }}
                        </td>
                    </tr>
                </table>
                ...
                <div class="feature-list">
                    <div class="feature-item">
                        <span
                            class="dot {{ $payment->subscription?->has_whatsapp ? 'dot-check' : 'dot-cross' }}"></span>
                        WhatsApp Bot
                    </div>
                    <div class="feature-item">
                    ...
                    <div class="feature-item">
                        <span
                            class="dot {{ $payment->subscription?->has_telegram ? 'dot-check' : 'dot-cross' }}"></span>
                        Telegram Bot
                    </div>
                    <div class="feature-item">

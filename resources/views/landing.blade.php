    ...
    <style>
        ...
        * {
        ...
        .reminder-preview {
            ...
            padding: 32px;
            position: relative;
            box-shadow: 0 20px 40px rgba(51, 118, 163, 0.08);
        }
...
<body>
    ...
    <main>
        <section class="hero">
            <div class="container">
                ...
                <p>Tasku adalah pusat kendali informasi tim Anda. Kirim pengumuman serentak ke WhatsApp, Discord, dan
                    Telegram tanpa perlu menyalin pesan satu per satu.</p>
                <a href="{{ route('register') }}" class="btn btn-primary"
                    style="padding: 18px 48px; font-size: 1.1rem;">Mulai Sekarang — Gratis</a>
                ...
                <div class="mockup-container">
                    ...
                    <div class="mockup-body">
                        <div class="mock-card">
                            ...
                            <p style="font-size:0.8rem; color:var(--slate-600);">"Halo tim, info rapat hari ini diundur
                                ke jam 2 ya!"</p>
                        </div>
                        <div class="mock-card center">
                            <span class="badge"
                                style="background:var(--primary); color:#fff; font-size:10px; padding:4px 10px; border-radius:5px; margin-bottom:15px; display:inline-block;">SISTEM
                                UTAMA</span>
                            <h5 style="font-weight:800; margin-bottom:10px;">Menyiarkan...</h5>
                            <p style="font-size:0.85rem; font-weight:600;">Mengirim ke 3 Platform sekaligus secara
                                instan.</p>
                        </div>
                        <div class="mock-card">
                            <div style="display:flex; align-items:center; gap:10px; margin-bottom:15px;">
        ...
        <section class="reminder-section" id="fitur">
            <div class="container">
                <div class="reminder-layout">
                    <div>
                        <span
                            style="color:var(--primary); font-weight:800; font-size:0.85rem; letter-spacing:1px; text-transform:uppercase;">Fitur
                            Unggulan</span>
                        <h2
                            style="font-family:'Space Grotesk', sans-serif; font-size:2.5rem; line-height:1.2; margin:20px 0;">
                    ...
                    <div class="reminder-preview">
                        ...
                        <div
                            ...
                            <span class="badge"
                                style="background:var(--slate-900); color:#fff; padding:5px 12px; border-radius:5px; font-size:10px;">TUGAS
                                MENDESAK</span>
                        ...
                        <p style="font-size:0.9rem; color:var(--slate-600); margin-bottom:25px;">Jangan lupa kumpulkan
                            tautan dokumen ke tabel sebelum besok malam.</p>
                        <div
                            style="background:#fff; border-radius:12px; padding:15px; border:1px solid #e2e8f0; display:flex; justify-content:space-between;">
                            <div>
                                <small
                                    style="display:block; color:var(--slate-400); font-weight:700; font-size:9px; text-transform:uppercase;">Tenggat
                                    Waktu</small>
                                <span style="font-weight:800; color:#ef4444; font-size:0.95rem;">Besok, 23:59 WIB</span>
                            </div>
                            <div style="text-align:right;">
                                <small
                                    style="display:block; color:var(--slate-400); font-weight:700; font-size:9px; text-transform:uppercase;">Status</small>
                                <span class="badge"
                                    style="background:#eef2ff; color:var(--primary); font-size:10px;">KIRIM ULANG
                                    H-1</span>
                            </div>
                        </div>
                    </div>
        ...
        <section class="pricing" id="pricing">
            <div class="container" style="text-align:center;">
                <h2 style="font-family:'Space Grotesk', sans-serif; font-size:2.5rem; margin-bottom:15px;">Investasi
                    Sesuai Kebutuhan</h2>
                ...
                <div class="pricing-grid">
                    <div class="p-card">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-outline w-100"
                            style="justify-content:center;">Pilih Dasar</a>
                    </div>
                    ...
                    <div class="p-card featured">
                        ...
                        <ul class="feature-list">
                            <li><i class="fa-solid fa-plus" style="color:var(--primary)"></i> Tambah per 5 Anggota
                            </li>
                            <li><i class="fa-solid fa-plus" style="color:var(--primary)"></i> Pengingat Pintar Aktif
                            </li>
                            <li><i class="fa-solid fa-plus" style="color:var(--primary)"></i> Pajak PPN 10% Transparan
                            </li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-primary w-100"
                            style="justify-content:center; background:var(--primary);">Cek Kalkulator</a>
                    </div>
                    ...
                    <div class="p-card">
                        ...
                        <ul class="feature-list">
                            <li><i class="fa-brands fa-whatsapp" style="color:#25d366"></i> WhatsApp (Segera Hadir)
                            </li>
                        ...
                        <a href="{{ route('register') }}" class="btn btn-outline w-100"
                            style="justify-content:center;">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section style="padding: 100px 0; text-align: center; background: var(--slate-900); color: #fff;">
            <div class="container">
                <h2 style="font-family:'Space Grotesk', sans-serif; font-size:2.5rem; margin-bottom:20px;">Siap
                    Mengelola Tim Lebih Cepat?</h2>
                <p style="color:var(--slate-400); margin-bottom:40px;">Daftar sekarang dan nikmati kemudahan koordinasi
                    tanpa hambatan.</p>
                <a href="{{ route('register') }}" class="btn btn-primary"
                    style="padding: 20px 60px; font-size: 1.2rem; background:var(--primary);">Daftar Akun Tasku
                    Sekarang</a>
            </div>
        </section>
    </main>
    ...
    <footer
        style="padding:60px 0; text-align:center; border-top:1px solid #e2e8f0; color:var(--slate-400); font-size:0.85rem;">
        <div class="container">

        ...
        <div class="row justify-content-center align-items-center g-5">
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="pe-lg-5">
                    ...
                    <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-bold mb-4 shadow-xs">
                    ...
                    <p class="text-secondary fs-6 mb-5 lh-lg">
                        Daftar sekarang untuk mulai mengirim pengumuman otomatis, mengelola anggota, dan meningkatkan produktivitas tim dalam satu aplikasi.
                    </p>

                    <div class="row g-3">
                        <div class="col-sm-6">
                            <div class="p-3 bg-white rounded-4 shadow-xs border h-100">
                                <div class="bg-primary bg-opacity-10 p-2 rounded-3 text-primary d-inline-block mb-2"><i class="fa-solid fa-check"></i></div>
                        ...
                        <div class="col-sm-6">
                            <div class="p-3 bg-white rounded-4 shadow-xs border h-100">
                                <div class="bg-success bg-opacity-10 p-2 rounded-3 text-success d-inline-block mb-2"><i class="fa-solid fa-bell"></i></div>
                ...
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden">
                    <div class="card-body p-4 p-md-5 bg-white">
                        ...
                        <form action="{{ route('register.auth') }}" method="POST">
                            ...
                            {{-- Nomor WA --}}
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary text-uppercase tracking-wider">Nomor WhatsApp</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-2 border-end-0 rounded-start-3 text-muted">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-sm-6">
                                    <label class="form-label small fw-bold text-secondary text-uppercase tracking-wider">Sandi</label>
                                    <input type="password" name="password"
                                        class="form-control form-control-lg border-2 rounded-3 fs-6 @error('password') is-invalid @enderror"
                                        placeholder="••••••">
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label small fw-bold text-secondary text-uppercase tracking-wider">Ulangi</label>
                        ...
                        <div class="text-center">
                            <p class="small text-muted mb-0">Sudah memiliki akun?
                                <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-none">Masuk ke Akun</a>
                            </p>
...
<style>
    ...
    .input-group-text { transition: border-color 0.2s; }
    .input-group:focus-within .input-group-text { border-color: var(--tasku-primary); }
</style>
@endsection

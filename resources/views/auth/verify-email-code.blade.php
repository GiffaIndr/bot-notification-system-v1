...
@section('content2')
<div class="min-vh-100 d-flex align-items-center" style="background-color: var(--tasku-bg); font-family: 'Plus Jakarta Sans', sans-serif;">
                ...
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden">
                    <div class="card-body p-4 p-md-5 bg-white">
                        ...
                        <form action="{{ route('register.verify.submit') }}" method="POST" class="mb-3">
                            @csrf
                            <label class="form-label small fw-bold text-secondary text-uppercase">Kode Verifikasi</label>
                            <input type="text" name="code" class="form-control form-control-lg text-center fw-bold mb-3"
                                placeholder="123456" maxlength="6" inputmode="numeric" value="{{ old('code') }}" required>
                        ...
                        <div class="text-center">
                            <a href="{{ route('register') }}" class="small text-secondary fw-semibold text-decoration-none">
                                <i class="fa-solid fa-chevron-left me-1" style="font-size: 10px;"></i> Kembali ke Form Daftar
                            </a>
                        </div>
                    </div>
                </div>
